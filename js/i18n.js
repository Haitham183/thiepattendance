...
const i18n = {
  en: {
    ...
    specDistribution: 'Trainees by Specialization',
    instructorWorkload: 'Instructor Workload (Groups)',
    evalTrend: 'Evaluation Performance Trend',
    // Specializations
    ...
    backupTitle: 'Database Management', backupBtn: 'Download Backup',
    restoreBtn: 'Restore from File', backupDesc: 'Download all system data as a JSON file for backup.',
    restoreDesc: 'Upload a backup file to restore data. Warning: Current data will be overwritten.',
    restoreConfirm: 'Are you sure you want to restore? All current data will be lost and the app will reload.',
    restoreSuccess: 'Data restored successfully. Reloading app...',
    restoreError: 'Invalid backup file or error during restore.',
    // Days
  ...
  ar: {
    ...
    specDistribution: 'توزيع المتدربين حسب التخصص',
    instructorWorkload: 'عبء عمل المدربين (المجموعات)',
    evalTrend: 'منحنى أداء التقييمات',
    // Specializations
    ...
    backupTitle: 'إدارة قاعدة البيانات', backupBtn: 'تحميل نسخة احتياطية',
    restoreBtn: 'استعادة من ملف', backupDesc: 'تحميل جميع بيانات النظام في ملف JSON للحفظ.',
    restoreDesc: 'رفع ملف نسخة احتياطية لاستعادة البيانات. تنبيه: سيتم مسح البيانات الحالية.',
    restoreConfirm: 'هل أنت متأكد من الاستعادة؟ سيتم مسح جميع البيانات الحالية وإعادة تشغيل التطبيق.',
    restoreSuccess: 'تم استعادة البيانات بنجاح. جارٍ إعادة تحميل التطبيق...',
    restoreError: 'ملف غير صالح أو حدث خطأ أثناء الاستعادة.',
    // Days
